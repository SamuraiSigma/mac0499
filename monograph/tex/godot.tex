...
A classe \textit{Resource} herda de \textit{Reference}s, adquirindo sua característica de liberação automática de memória quando não há nenhuma referência à instância.
